...
public class Search_AsyncTask extends FragmentActivity{
	...
	ProgressBar progressBar;
	  ...
	  public void onCreate(Bundle savedInstanceState) {
	      ...
	      GetSearchResults searchResults = new GetSearchResults(getApplicationContext(), this, progressBar);
	...
	private GetSearchResults(Context context, Search_AsyncTask b, ProgressBar theBar) {
	aContext = context;
	search = b;
	pBar = theBar;
	}
